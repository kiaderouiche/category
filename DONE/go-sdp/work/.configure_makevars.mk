...
BUILDLINK_PREFIX.go-randutil=	/usr/pkg
TOOLS_DEPENDS.ghostscript=	ghostscript>=6.01:../../print/ghostscript
_BLNK_PHYSICAL_PATH.LOCALBASE=	/usr/pkg
_BLNK_PHYSICAL_PATH.WRKDIR=	/usr/pkgsrc/category/go-sdp/work
_BLNK_PKG_DBDIR.go-randutil=	/usr/pkg/pkgdb/go-randutil-0.1.0
_IGNORE_INFO_PATH=	
_MANCOMPRESSED=	no
_MANZ=	no
