...
install_purelib = '/usr/pkg/lib/python3.8/site-packages'
install_platlib = '/usr/pkg/lib/python3.8/site-packages'
install_lib = '/usr/pkg/lib/python3.8/site-packages'
install_headers = '/usr/pkg/include/python3.8/patool'
install_scripts = '/usr/pkg/bin'
config_dir = '/usr/pkg/share/patool'
install_data = '/usr/pkg'
name = 'patool'
version = '1.12'
