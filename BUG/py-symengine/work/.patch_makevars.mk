...
BUILDLINK_PREFIX.py-cython=	/usr/pkg
...
_BLNK_PHYSICAL_PATH.WRKDIR=	/usr/pkgsrc/category/py-symengine/work
_BLNK_PKG_DBDIR.py-cython=	/usr/pkg/pkgdb/py37-cython-0.29.21
_BLNK_PKG_DBDIR.python37=	/usr/pkg/pkgdb/python37-3.7.9nb1
_IGNORE_INFO_PATH=	
_MANCOMPRESSED=	no
_MANZ=	no
_USE_TOOLS=	[ awk basename cat chgrp chmod chown cmake cmp cp cpack curl cut date diff digest dirname echo egrep env expr false fgrep find grep gzcat head hostname id install ln ls mkdir mv printf pwd rm rmdir sed sh sort tail tar test touch tr true uname wc xargs
