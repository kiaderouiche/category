...
_BLNK_PHYSICAL_PATH.WRKDIR=	/usr/pkgsrc/category/nusigma-pyr/work
_IGNORE_INFO_PATH=	
_MANCOMPRESSED=	no
_MANZ=	no
...
_USE_TOOLS=	[ awk basename cat chgrp chmod chown cmp cp curl cut date diff digest dirname echo egrep env expr false fgrep find gmake grep gzcat head hostname id install ln ls mkdir mv perl printf pwd rm rmdir sed sh sort tail tar test touch tr true uname wc xargs
