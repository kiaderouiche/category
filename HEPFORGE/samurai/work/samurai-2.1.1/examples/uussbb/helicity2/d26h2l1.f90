module     uussbb_d26h2l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity2/d26h2l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      &vak1k2)-(t1*abb26n5*dotproduct(Q, spvak3k4)+t1*abb26n2*es34+abb26n4*es56)&
   ...
   pure function brack_4(Q, mu2) result(brack)
      ...
      t1 = dotproduct(Q, spvak5k6)
      brack = (((4.0_ki)*(t1*abb26n2*es34+t1*abb26n5*dotproduct(Q, spvak3k4)-t1*&
