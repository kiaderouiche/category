module     uussbb_d14h2l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity2/d14h2l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      t6 = dotproduct(Q, Q)
      brack = ((8.0_ki)*((abb14n7+t1*abb14n11+t2*abb14n6+t3*abb14n8)*mu2+(2.0_ki&
      &)*t1*t2*t3+t4*abb14n9*dotproduct(Q, spvak1k4)+t5*abb14n5*dotproduct(Q, sp&
      &vak5k4)-(t5*abb14n10*dotproduct(Q, spvak3k2)+t4*abb14n3*dotproduct(Q, spv&
      &ak3k6)+t3*t6*abb14n8+t2*t6*abb14n6+t1*t6*abb14n11+t5*abb14n4+t4*abb14n2))&
      &)
