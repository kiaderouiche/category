module     uussbb_diagramsh2l0
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity2/diagramsh2
   ! l0.f90
...
contains
   function     amplitude()
      ...
      if (debug_lo_diagrams) then
         ...
         &bb1n6*t1/t8+i_*abb1n8*t1/t8-(i_*abb1n7*t1/t8+i_*abb1n5*t1/t8+i_*abb1n3&
         &*t1/t8+i_*abb1n1*t1/t8))),&
            &1, 2, 19)
      end if
      amplitude = amplitude + (((2.0_ki)*(i_*abb1n2*t1/t8+i_*abb1n4*t1/t8+i_*abb&
      &1n6*t1/t8+i_*abb1n8*t1/t8-(i_*abb1n7*t1/t8+i_*abb1n5*t1/t8+i_*abb1n3*t1/t&
      &8+i_*abb1n1*t1/t8))))
   end function     amplitude
end module uussbb_diagramsh2l0
