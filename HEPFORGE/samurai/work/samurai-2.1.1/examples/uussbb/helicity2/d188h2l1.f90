module     uussbb_d188h2l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity2/d188h2l1.f
   ! 90
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      &188n2-(abb188n6*dotproduct(Q, spvak3k6)+abb188n3*dotproduct(Q, spvak5k4)+&
   ...
   pure function brack_4(Q, mu2) result(brack)
      ...
      brack = ((2.0_ki)*(-(t1*mu2*abb188n14+t1*t2*dotproduct(Q, spvak5k4)+t1*t2*&
      &abb188n11)))
