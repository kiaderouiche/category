module     uussbb_d129h2l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity2/d129h2l1.f
   ! 90
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      brack = ((2.0_ki)*(t1*abb129n2*dotproduct(Q, spvak5k4)+t1*abb129n3*dotprod&
      &uct(Q, spvak5k6)))
