module     uussbb_d15h2l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity2/d15h2l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      t6 = dotproduct(Q, Q)
      brack = ((8.0_ki)*((t1*abb15n11+t2*abb15n6+t3*abb15n8-abb15n7)*mu2+(2.0_ki&
      &)*t1*t2*t3+t4*abb15n3*dotproduct(Q, spvak3k6)+t5*abb15n10*dotproduct(Q, s&
      &pvak3k2)-(t5*abb15n5*dotproduct(Q, spvak5k4)+t4*abb15n9*dotproduct(Q, spv&
      &ak1k4)+t3*t6*abb15n8+t2*t6*abb15n6+t1*t6*abb15n11+t5*abb15n4+t4*abb15n2))&
      &)
