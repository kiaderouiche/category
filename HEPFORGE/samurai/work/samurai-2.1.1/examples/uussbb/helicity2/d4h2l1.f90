module     uussbb_d4h2l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity2/d4h2l1.f90
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      brack = ((2.0_ki)*(abb4n3-abb4n5*dotproduct(Q, spvak3k2)))
   ...
   pure function brack_8(Q, mu2) result(brack)
      ...
      brack = ((2.0_ki)*(abb4n4-abb4n6*dotproduct(Q, spvak1k4)))
