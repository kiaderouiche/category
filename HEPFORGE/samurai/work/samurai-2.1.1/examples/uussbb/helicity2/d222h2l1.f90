module     uussbb_d222h2l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity2/d222h2l1.f
   ! 90
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      brack = ((4.0_ki)*(mu2*abb222n4+t1*t3*abb222n5+t2*t3*abb222n6-(t2*abb222n3&
      &+t1*abb222n2)))
   ...
   pure function brack_4(Q, mu2) result(brack)
      ...
      brack = ((2.0_ki)*(t1*abb222n1-(t1*abb222n6*dotproduct(Q, spvak1k6)+t1*abb&
      &222n5*dotproduct(Q, spvak1k2))))
