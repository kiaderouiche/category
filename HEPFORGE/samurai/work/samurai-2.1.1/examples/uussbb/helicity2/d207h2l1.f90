module     uussbb_d207h2l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity2/d207h2l1.f
   ! 90
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      brack = ((4.0_ki)*(abb207n5+t1*abb207n2+t3*abb207n7+abb207n6*es345+t1*t2*a&
      &bb207n3+t2*t3*abb207n8-(abb207n6*es45+mu2*abb207n6+t2*abb207n4)))
   ...
   pure function brack_4(Q, mu2) result(brack)
      ...
      brack = ((2.0_ki)*(-(t1*abb207n8*dotproduct(Q, spvak5k6)+t1*abb207n3*dotpr&
      &oduct(Q, spvak1k6))))
