module     uussbb_d6h2l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity2/d6h2l1.f90
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      brack = ((2.0_ki)*(-(abb6n3*dotproduct(Q, spvak5k4)+abb6n1)))
   ...
   pure function brack_8(Q, mu2) result(brack)
      ...
      brack = ((2.0_ki)*(-(abb6n4*dotproduct(Q, spvak3k6)+abb6n2)))
