module     uussbb_d7h2l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity2/d7h2l1.f90
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      t6 = dotproduct(Q, Q)
      brack = ((8.0_ki)*((t1*abb7n11+t2*abb7n6+t3*abb7n8-abb7n7)*mu2+(2.0_ki)*t1&
      &*t2*t3+t4*abb7n3*dotproduct(Q, spvak3k6)+t5*abb7n10*dotproduct(Q, spvak3k&
      &2)-(t5*abb7n5*dotproduct(Q, spvak5k4)+t4*abb7n9*dotproduct(Q, spvak1k4)+t&
      &3*t6*abb7n8+t2*t6*abb7n6+t1*t6*abb7n11+t5*abb7n4+t4*abb7n2)))
