module     uussbb_d204h0l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity0/d204h0l1.f
   ! 90
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      brack = ((8.0_ki)*(-(abb204n4*dotproduct(Q, k6)+abb204n4*dotproduct(Q, k4)&
      &+abb204n4*dotproduct(Q, Q)))+(4.0_ki)*mu2*abb204n4)
   ...
   pure function brack_4(Q, mu2) result(brack)
      ...
      brack = ((2.0_ki)*(t2*abb204n5+t2*t3*abb204n6-(t1*t3*abb204n3+t1*abb204n2)&
      &))
