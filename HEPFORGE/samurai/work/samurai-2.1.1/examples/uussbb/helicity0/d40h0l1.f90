module     uussbb_d40h0l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity0/d40h0l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      &spvak6k5)-(t1*abb40n7*dotproduct(Q, spvak4k3)+t1*abb40n5*es56+abb40n2))+(&
   ...
   pure function brack_4(Q, mu2) result(brack)
      ...
      t1 = dotproduct(Q, spvak1k2)
      brack = (((4.0_ki)*(t1*abb40n5*es56+t1*abb40n7*dotproduct(Q, spvak4k3)-(t1&
      &*abb40n6*dotproduct(Q, spvak6k5)+t1*abb40n5*es34))+(8.0_ki)*(t1*abb40n5*d&
