module     uussbb_d14h0l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity0/d14h0l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      &bb14n5*dotproduct(Q, spvak6k3)-(t4*abb14n9*dotproduct(Q, spvak1k3)+t4*abb&
      &14n3*dotproduct(Q, spvak4k5)+t3*t6*abb14n8+t2*t6*abb14n6+t1*t6*abb14n11))&
      &)
