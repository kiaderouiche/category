module     uussbb_d90h0l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity0/d90h0l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      brack = ((4.0_ki)*(abb90n5*dotproduct(Q, spvak4k5)-(abb90n4*dotproduct(Q, &
      &spvak6k3)+abb90n2*dotproduct(Q, spvak4k2)))+(8.0_ki)*(mu2*abb90n6+t1*abb9&
      &0n7*dotproduct(Q, spvak6k5)-(t1*abb90n3*dotproduct(Q, spvak6k2)+abb90n6*d&
      &otproduct(Q, Q))))
