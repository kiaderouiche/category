module     uussbb_d4h0l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity0/d4h0l1.f90
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      brack = ((2.0_ki)*(abb4n3-abb4n6*dotproduct(Q, spvak1k3)))
   ...
   pure function brack_5(Q, mu2) result(brack)
      ...
      brack = (-4.0_ki)*abb4n2*dotproduct(Q, spvak6k5)
   ...
   pure function brack_8(Q, mu2) result(brack)
      ...
      brack = ((2.0_ki)*(abb4n4-abb4n5*dotproduct(Q, spvak4k2)))
