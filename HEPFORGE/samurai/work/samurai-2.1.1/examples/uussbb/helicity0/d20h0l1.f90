module     uussbb_d20h0l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity0/d20h0l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      brack = (((4.0_ki)*(t1*abb20n22+t1*abb20n24+t10*t11*abb20n21+t11*abb20n30*&
      &dotproduct(Q, spvak1k2)-(t8*t9*abb20n16+t6*t7*abb20n16+t4*t5*abb20n16+t2*&
      &t3*abb20n16+t10*t11*abb20n27+t1*abb20n23+t1*abb20n17))+(2.0_ki)*(t2*abb20&
      &n29+t2*abb20n6+t3*abb20n8+t5*abb20n10+t7*abb20n12+t7*abb20n26+t8*abb20n19&
      &+t8*abb20n2+t9*abb20n15-(t8*abb20n25+t8*abb20n14+t7*abb20n3+t7*abb20n20+t&
      &6*abb20n11+t5*abb20n5+t5*abb20n28+t4*abb20n9+t2*abb20n7))+(4.0_ki)*(abb20&
      &n18+abb20n23+abb20n4-(abb20n24+abb20n22+abb20n13))*mu2)*i_)
