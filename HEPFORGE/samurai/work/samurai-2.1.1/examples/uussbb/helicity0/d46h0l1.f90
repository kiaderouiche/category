module     uussbb_d46h0l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity0/d46h0l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      &k3k5)+t3*abb46n13*es234+t3*abb46n9*dotproduct(Q, spvak1k2)-(t4*t7*abb46n2&
