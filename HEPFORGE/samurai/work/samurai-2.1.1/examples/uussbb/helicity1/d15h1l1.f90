module     uussbb_d15h1l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity1/d15h1l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      &5n2+t5*abb15n4+(2.0_ki)*t1*t2*t3+t4*abb15n3*dotproduct(Q, spvak4k6)+t4*ab&
      &b15n9*dotproduct(Q, spvak1k3)-(t5*abb15n5*dotproduct(Q, spvak5k3)+t5*abb1&
