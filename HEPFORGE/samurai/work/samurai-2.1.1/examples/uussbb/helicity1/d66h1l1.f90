module     uussbb_d66h1l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity1/d66h1l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      brack = (((2.0_ki)*(t1*abb66n6+abb66n9*dotproduct(Q, spvak4k6)-t1*abb66n2)&
      &+(4.0_ki)*(t1*abb66n3+mu2*abb66n7+abb66n7*dotproduct(Q, k4)-(t1*t3*abb66n&
      &11+t1*t2*abb66n5+(2.0_ki)*abb66n7*dotproduct(Q, k3)+abb66n7*dotproduct(Q,&
      & Q)+t3*abb66n8+t2*abb66n4+t1*abb66n10)))*i_)
