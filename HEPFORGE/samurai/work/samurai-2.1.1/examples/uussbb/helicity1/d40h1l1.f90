module     uussbb_d40h1l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity1/d40h1l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      &spvak5k6)-(t1*abb40n7*dotproduct(Q, spvak4k3)+t1*abb40n5*es56+abb40n2))+(&
