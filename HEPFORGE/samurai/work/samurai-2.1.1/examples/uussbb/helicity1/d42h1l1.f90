module     uussbb_d42h1l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity1/d42h1l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      &*abb42n25+t1*abb42n8*es234+t2*abb42n17*dotproduct(Q, k6)-(t3*t5*abb42n14+&
      &t2*t5*abb42n22+t1*abb42n8*es61+t1*abb42n8*es34+t1*t4*t6+t1*abb42n11))+(2.&
      &0_ki)*(t2*abb42n7+t2*abb42n9+t7*abb42n20+t2*t4*abb42n18+t2*t5*abb42n6+t2*&
      &abb42n14*dotproduct(Q, spvak2k3)+t2*abb42n15*dotproduct(Q, spvak5k6)+t2*a&
   ...
   pure function brack_4(Q, mu2) result(brack)
      ...
      brack = ((4.0_ki)*((t1*abb42n24-abb42n10)*mu2+t1*t2*t3+t1*t2*abb42n26-(t2*&
      &t3*abb42n13+t2*abb42n12))*i_)
