module     uussbb_d143h1l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity1/d143h1l1.f
   ! 90
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      brack = ((2.0_ki)*(t1*abb143n2*dotproduct(Q, spvak1k2)-t1*abb143n1*dotprod&
      &uct(Q, spvak1k3)))
