module     uussbb_d7h1l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity1/d7h1l1.f90
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      &5*abb7n4+(2.0_ki)*t1*t2*t3+t4*abb7n3*dotproduct(Q, spvak4k6)+t4*abb7n9*do&
      &tproduct(Q, spvak1k3)-(t5*abb7n5*dotproduct(Q, spvak5k3)+t5*abb7n10*dotpr&
