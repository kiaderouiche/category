module     uussbb_d64h1l1
   ! file:      /home/thomasr/Work/samurai-processes/uussbb/helicity1/d64h1l1.f9
   ! 0
...
contains
   ...
   pure function brack_3(Q, mu2) result(brack)
      ...
      &))*mu2+t2*abb64n11+t3*abb64n12+t4*abb64n14+t2*t5*abb64n23+t3*t6*abb64n21+&
      &t4*abb64n21*dotproduct(Q, spvak6k2)-(t4*t6*abb64n22+t2*abb64n21*dotproduc&
      &t(Q, spvak3k2)+t1*t5*abb64n21+t4*abb64n13+t2*abb64n9+t1*abb64n10))*i_)
   ...
   pure function brack_4(Q, mu2) result(brack)
      ...
      &))*mu2+t1*abb64n6+t3*abb64n4+t4*abb64n7+t1*t6*abb64n22+t2*t5*abb64n21+t3*&
      &abb64n21*dotproduct(Q, spvak1k4)-(t4*t6*abb64n21+t3*t5*abb64n23+t1*abb64n&
      &21*dotproduct(Q, spvak1k5)+t3*abb64n5+t2*abb64n3+t1*abb64n8+t1*abb64n2))*&
      &i_)
