...
setup.py
docs/Makefile
docs/about_microservices.rst
docs/built_in_dependency_providers.rst
docs/built_in_extensions.rst
docs/cli.rst
docs/community_extensions.rst
docs/conf.py
docs/contributing.rst
docs/dependency_injection_benefits.rst
docs/getting_in_touch.rst
docs/index.rst
docs/installation.rst
docs/key_concepts.rst
docs/license.rst
docs/release_notes.rst
docs/similar_projects.rst
docs/spelling_wordlist.txt
docs/testing.rst
docs/what_is_nameko.rst
docs/writing_extensions.rst
docs/_templates/sidebarlinks.html
docs/examples/README
docs/examples/__init__.py
docs/examples/advanced_http.py
docs/examples/anatomy.py
docs/examples/async_rpc.py
docs/examples/auth.py
docs/examples/config_dependency_provider.py
docs/examples/event_broadcast.py
docs/examples/events.py
docs/examples/expected_exceptions.py
docs/examples/helloworld.py
docs/examples/http.py
docs/examples/http_exceptions.py
docs/examples/index.rst
docs/examples/rpc.py
docs/examples/sensitive_arguments.py
docs/examples/service_container.py
docs/examples/service_runner.py
docs/examples/sqs_receive.py
docs/examples/sqs_send.py
docs/examples/sqs_service.py
docs/examples/standalone_events.py
docs/examples/standalone_rpc.py
docs/examples/timer.py
docs/examples/travis.py
docs/examples/websocket_rpc.py
docs/examples/test/__init__.py
docs/examples/test/test_examples.py
docs/examples/testing/alternative_dependency_unit_test.py
docs/examples/testing/entrypoint_hook_test.py
docs/examples/testing/entrypoint_waiter_test.py
...
nameko/testing/rabbit.py
nameko/testing/services.py
nameko/testing/utils.py
nameko/testing/waiting.py
nameko/testing/websocket.py
nameko/utils/__init__.py
nameko/utils/retry.py
nameko/utils/concurrency/__init__.py
nameko/web/__init__.py
nameko/web/handlers.py
...
test/test_extension_sharing.py
test/test_extensions.py
test/test_handle_result.py
test/test_log_helpers.py
test/test_messaging.py
test/test_provider_collector.py
test/test_queue_consumer.py
test/test_rpc.py
test/test_rpc_responder.py
test/test_serialization.py
test/test_service_runner.py
test/test_timers.py
test/amqp/__init__.py
test/amqp/test_publish.py
test/cli/test_backdoor.py
test/cli/test_main.py
test/cli/test_run.py
test/cli/test_shell.py
test/cli/test_show_config.py
...
test/testing/test_pytest_plugin.py
test/testing/test_services.py
test/testing/test_utils.py
test/testing/test_waiting.py
test/utils/__init__.py
test/utils/test_retry.py
test/utils/test_utils.py
test/web/test_http_handler.py
test/web/test_server.py
test/web/test_websocket.py